...
<body>
	...
	<div class="form2">
		<div class="container-fluid">
			<div>
				<div>
					<h1 style="text-align: center;">Compila
						la domanda</h1>
						...
						<div class="form">
							...
							<div class="form-group">
								<label class="l1">Cognome</label> <input class="input"
									...
									value="${cognome}" placeholder="${cognome}"
									style="color: black;" required>
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								<label class="l1">Email</label> <input class="input"
									type="email" class="form-control" id="email" value="${email}"
							...
							<c:forEach items="${doc}" var="doc" varStatus="status">
								<div class="form-group">
									<input type="hidden" id="titolodoc_${status.index}"
										...
										type="hidden" id="maxdoc_${status.index}"
										value='${doc.maxdim}'> <label class="l2">Inserire
										${doc.titolodocumento}</label>
									<h7>Formato documento: ${doc.formatodocumento}</h7>
									<br>
									<c:choose>
										<c:when test="${doc.formatodocumento == 'img'}">
											<input type="file" accept=".jpeg,.png,.jpg"
												id="doc_${status.index}" name="doc" maxlength="150" style="background-color: #33CC66;" required>
										</c:when>
