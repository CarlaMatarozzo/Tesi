...
<body>
	...
	<div class="form2">
		<div class="container-fluid">
			<div>
				<div>
					<h1 style="text-align: center;">Crea
						Bando</h1>
				...
				<div class="row">
					<div class="col">
						<div class="form">
							...
							<div class="form-group">
								<label class="l1">Titolo</label> <input class="input"
							...
							<div class="form-group">
								...
								<label class="l1" for="scelta">Docente</label> <select
									id="sceltaDocente" style="height: 20px !important;">
					...
					<div class="col">
						<div id="formContainer">
							...
							<div class="form-group">
								<label class="l1" for="scelta">Formato documento</label> <select
									id="scelta" style="height: 20px !important;">
							...
							<div class="form-group">
								<label class="l1">Minima dimensione</label> <input class="input"
									type="number" name="minSize0" class="form-control"
									id="minSize0" placeholder="Minima dimensione"
									style="color: black;" required>
							</div>
							<div class="form-group">
								<label class="l1">Massima dimensione</label> <input
									class="input" type="number" name="maxSize0"
									class="form-control" id="maxSize0"
									placeholder="Massima dimensione" style="color: black;" required>
							</div>
						</div>
						<button id="addDoc"  class="btn btn-xs btn-danger btn-nuova-bozza" style="width: 50%; border-color: transparent; background-color: #33CC66;">Aggiungi documento</button>
					</div>
					<div class="col-md-12 text-center mb-3">
						<button type="submit" id="btnCreaBando" class="btn btn-xs btn-danger btn-nuova-bozza"
